...
import ThreeTone3Words from "../data/ThreeTone3Words";

export default function TheoryDetailRule3Tone3() {
  // Lấy dữ liệu từ TheoryCards.js
  const cardData = TheoryCards.find(card => card.slug === "three-tone3");
  ...
  return (
    <div className="w-full min-h-screen p-4 sm:p-6 lg:p-10">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/95 backdrop-blur-sm border border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg mb-6 sm:mb-8">
          <div className="flex justify-center">
            <div className="w-full max-w-3xl">
              <img 
                src="/images/3_tone3.png" 
                alt="Minh họa quy tắc biến âm ba dấu 3"
        ...
        <VocabTable vocabs={ThreeTone3Words} />
      </div>
    </div>
  );
}
